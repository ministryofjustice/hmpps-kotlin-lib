...
import uk.gov.justice.digital.hmpps.testappreactive.resource.CustomAuthAwareAuthenticationTokenConverter
...
class CustomTokenConverterTest : IntegrationTestBase() {
  ...
  class CustomizerConfiguration {
    ...
    fun resourceServerCustomizer() = ResourceServerConfigurationCustomizer {
      ...
      oauth2 { reactiveTokenConverter = CustomAuthAwareAuthenticationTokenConverter { CaseloadFinder().find() } }
    }
  }
